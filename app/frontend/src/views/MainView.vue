  ...
  <div class="main-view">
    ...
    <header class="app-header">
      <div class="header-left">
        <div class="brand" @click="router.push('/')">MIROWORLD</div>
      </div>
    ...
    <main class="content-area">
      ...
      <div class="panel-wrapper right" :style="rightPanelStyle">
        ...
        <!-- Step 1: graph build. Step1GraphBuild owns the canonical transition
             to /simulation/:id, so there is only one environment workflow. -->
...
const handleNewProject = async () => {
  ...
  try {
    ...
    if (pending.additionalContext && pending.additionalContext.trim()) {
...
@media (max-width: 600px) {
  ...
  .step-title, .step-name { display: none; }
  .view-switcher { padding: 3px; }
  .switch-btn { padding: 6px 10px; font-size: 11px; }
  .world-entry { margin: 0 8px 8px; }
  .world-entry-desc { display: none; }
